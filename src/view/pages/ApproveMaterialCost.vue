<template>
  <div>
    ...
    <Approvematerialcost></Approvematerialcost>
  </div>
</template>
...
import Approvematerialcost from "@/view/content/widgets/advance-table/Approve_material_cost.vue";

export default {
  name: "approvegiavattu",
  components: {
    Approvematerialcost,
