    ...
    <div class="add-gr1">
      ...
      <b-form>
        ...
        >
          ...
          <div class="col-span-2 row-span-3 mt-10 mb-10 ml-5 mr-5">
             <img
              class="symbol-label"
...
export default {
  ...
  data() {
    return {
      ...
      codeEmploy:'',
      selectedAcount: null, // Array reference
      acount: [],
      nameEmploy:'',
      teleEmploy:'',
      emailEmploy:'',
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: "Thông tin của tôi" }]);
  },
    created() {
        let acount = this['storeqlda/currentUser'].email
        this["storeqlda/getEmployWithAcount"](acount).then((res)=>{
          this.codeEmploy = res.data.codeEmploy;  
          let data = {
          value: res.data.userNameEmploy,
          text: res.data.userNameEmploy,
        };
        this.acount.push(data);                                  
        this.selectedAcount = res.data.userNameEmploy;                                  
  ...
  methods: {
    ...mapActions([
      ...
      "storeqlda/getEmployWithAcount",
      "storeqlda/getUrlAvatar"
    ]),
    custom_label({ text }) {
      return `${text}`;
    },
     handleUpdate() {					
      var data = {
        ...
        userNameEmploy:this.selectedAcount,
