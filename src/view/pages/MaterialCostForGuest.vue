<template>
  <div>
    ...
    <MaterialCostForGuest></MaterialCostForGuest>
  </div>
</template>
...
import MaterialCostForGuest from "@/view/content/widgets/advance-table/Material_cost_for_guest.vue";

export default {
  name: "giavattu",
  components: {
    MaterialCostForGuest,
